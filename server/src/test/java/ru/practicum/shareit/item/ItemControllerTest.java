...
class ItemControllerTest {
    ...
    void setUp() {
        ...
        itemResponseWithBookingDateDto.setComments(List.of(commentDto));
    ...
    void postItemWhenItemRequestIsValidThenPostItem() {
        ...
        when(itemService.postItem(any(), anyLong())).thenReturn(itemResponseDto);
        ...
        verify(itemService, times(1)).postItem(any(ItemRequestDto.class), anyLong());
    }
    ...
    @SneakyThrows
    @Test
    void getItemByIdWhenItemRequestIsValidThenGetItem() {
        Long itemId = 1L;
        Long userId = 1L;
        ...
        mockMvc.perform(get("/items/{itemId}", itemId)
                        ...
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id", is(itemResponseWithBookingDateDto.getId()), Long.class))
                .andExpect(jsonPath("$.name", is(itemResponseWithBookingDateDto.getName()), String.class))
                .andExpect(jsonPath("$.description", is(itemResponseWithBookingDateDto.getDescription()), String.class))
                .andExpect(jsonPath("$.available", is(itemResponseWithBookingDateDto.isAvailable()), Boolean.class))
                .andExpect(jsonPath("$.lastBooking", is(itemResponseWithBookingDateDto.getLastBooking().format(DateTimeFormatter.ISO_DATE_TIME))))
                .andExpect(jsonPath("$.nextBooking", is(itemResponseWithBookingDateDto.getNextBooking().format(DateTimeFormatter.ISO_DATE_TIME))))
                .andExpect(jsonPath("$.comments", hasSize(greaterThan(0))));
        verify(itemService, times(1)).getItemById(anyLong(), anyLong());
    }

    @SneakyThrows
    @Test
    void getItemsWhenItemRequestIsValidThenGetItem() {
        Long userId = 1L;
        ...
        mockMvc.perform(get("/items", userId)
                        ...
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[0].id", is(itemResponseWithBookingDateDto.getId()), Long.class))
                .andExpect(jsonPath("$[0].name", is(itemResponseWithBookingDateDto.getName()), String.class))
                .andExpect(jsonPath("$[0].description", is(itemResponseWithBookingDateDto.getDescription()), String.class))
                .andExpect(jsonPath("$[0].available", is(itemResponseWithBookingDateDto.isAvailable()), Boolean.class))
                .andExpect(jsonPath("$[0].lastBooking", is(itemResponseWithBookingDateDto.getLastBooking().format(DateTimeFormatter.ISO_DATE_TIME))))
                .andExpect(jsonPath("$[0].nextBooking", is(itemResponseWithBookingDateDto.getNextBooking().format(DateTimeFormatter.ISO_DATE_TIME))))
                .andExpect(jsonPath("$[0].comments", hasSize(greaterThan(0))));
        verify(itemService, times(1)).getItems(anyLong());
    }

    @SneakyThrows
    @Test
    void getItemByTextWhenRequestIsValidThenGetItems() {
        String text = "text";
        ...
        mockMvc.perform(get("/items/search?text={text}", text)
                ...
                .andExpect(jsonPath("$[0].available", is(itemResponseDto.isAvailable()), Boolean.class))
                .andExpect(jsonPath("$[0].request", is(itemResponseDto.getRequest()), Long.class));
        verify(itemService, times(1)).getItemByText(anyString());
    }

    @SneakyThrows
    @Test
    void postCommentWhenRequestCommentIsValidThenPostComment() {
        Long itemId = 1L;
        Long userId = 1L;

        when(itemService.postComment(any(), anyLong(), anyLong(), any(LocalDateTime.class))).thenReturn(commentDto);
